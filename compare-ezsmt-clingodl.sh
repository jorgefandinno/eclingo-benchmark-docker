...
docker cp $CONTAINER_NAME:/root/run-benchmark/running/benchmark-tool-$SOLVER_3/experiments/results/$SOLVER_3/$SOLVER_3.ods results/$SOLVER_3/
docker cp $CONTAINER_NAME:/root/run-benchmark/running/benchmark-tool-$SOLVER_3/output/project/zuse/results/suite/ results/$SOLVER_3/

mkdir -p results/$SOLVER_4
docker cp $CONTAINER_NAME:/root/run-benchmark/running/benchmark-tool-$SOLVER_4/experiments/results/$SOLVER_4/$SOLVER_4.ods results/$SOLVER_4/
docker cp $CONTAINER_NAME:/root/run-benchmark/running/benchmark-tool-$SOLVER_4/output/project/zuse/results/suite/ results/$SOLVER_4/
